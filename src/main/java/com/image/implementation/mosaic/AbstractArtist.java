...
public abstract class AbstractArtist implements IMosaicArtist
{
    ...
    @Override
    public final BufferedImage getTileForRegion(BufferedImage region)
    {
        if (region.getWidth() > tileWidth || region.getHeight() > tileHeight)
        {
        ...
        drawTileForRegion(region, result);
        return result;
    }
     ...
     */
    protected abstract void drawTileForRegion(BufferedImage region, BufferedImage target);
